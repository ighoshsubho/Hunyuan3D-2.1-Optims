...
And patch this file - from torchvision.transforms.functional import rgb_to_grayscale (path - usr/local/lib/python3.11/dist-packages/basicsr/data/degradations.py)
